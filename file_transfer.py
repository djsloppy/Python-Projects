...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        # Creates entry source directory selection
    ...
    def transferFiles(self):
        ...
        # Gets list of files in the source dir
        ...
        for i in source_files:
            ...
            file = source + '/' + i
            # Gets the modified time from the file and converts it from epoch time
            # to a readable time
            fileTime = datetime.datetime.fromtimestamp(os.path.getmtime(file))
            # Check to see if the time difference from file time to current time
            # is less than 24 hours. If so, then move the file.
