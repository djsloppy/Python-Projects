...
def nice_mean(nice,mean,name):
    ...
    while stop:
        ...
        if pick == "n":
            print("\nThe stranger gives you a thumbs up and walks away...")
            nice = (nice + 1)
            stop = False
        if pick == "m":
            print("\nThe stranger calls you rude \nslaps you and storms off...")
            mean = (mean + 1)
            stop = False
...
def win(nice,mean,name):
    ...
    print("\nNice job {}, \nYou shown that it pays to be nice \nthe last stranger hands you a $100 bill!".format(name))
    # call again function and pass in our variables
    again(nice,mean,name)

def lose(nice,mean,name):
    # Substitute the {} wildcards with out variable values
    print("\nAhhh too bad, game over! \n{}, the last stranger\nstabs you and runs away!".format(name))
    # call again function and pass in our variables
    again(nice,mean,name)
